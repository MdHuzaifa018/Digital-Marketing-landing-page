...
const WhyDigitalMarketing = () => {
  return (
    <section className="section-py" aria-labelledby="why-dm-heading">
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="text-slate-700 font-500 text-subheading mb-8">
              Four pillars that make offline training at Flybit Academy effective, practical, and heavily career-oriented.
            </p>
          </div>
